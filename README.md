...
Report examples:
* [Regular report for Postgres 19 database](https://zubkov-andrei.github.io/pg_profile/report_examples/pg19.html)
* [Differential report for Postgres 19 database](https://zubkov-andrei.github.io/pg_profile/report_examples/pg19_diff.html)
...
## Supported versions
## PostgreSQL
* **19** supported since version 4.14
...
* **1.13** supported since version 4.14
...
* **2.3.2** supported since version 4.14
