  ...
  '[{'
    ...
    '"rows": ['
        ...
        '{"caption": "WAL FPI", "title": "Total number of WAL full page images generated", "cells": ['
            '{"id": "wal_fpi"}'
        ']},'
        '{"caption": "WAL FPI generated", "title": "Total amount of WAL full page images", "condition": "wal_fpi_bytes", "cells": ['
            '{"id": "wal_fpi_bytes_text"}'
        ']},'
        '{"caption": "WAL FPI per second", "title": "Average amount of WAL full page images generated per second", "condition": "wal_fpi_bytes", "cells": ['
...
(1, 'tbspst', 'srvstat', 1400, 'Tablespace statistics', 'Tablespace statistics', NULL, NULL, NULL,
  '[{'
    ...
    ']'
  '}]'::jsonb),
(1, 'lockstat', 'srvstat', 1450, 'Lock statistics', 'Lock statistics', 'stat_lock', NULL, NULL, NULL),
(1, 'lockstatrst', 'srvstat', 1460, NULL, NULL, 'stat_lock_reset', NULL,
  '{"class": "warning", "text": "Lock stats reset was detected during report interval. Statistic values may be affected"}',
  '[{'
    '"type": "row_table",'
    ...
    '"columns": ['
      '{"caption": "Sample ID", "id": "sample_id", "class": "table_obj_name", '
        '"title": "Sample identifier with detected reset"},'
      '{"caption": "Lock type", "id": "locktype", "class": "table_obj_name", '
        '"title": "Type of the lockable object"},'
      '{"caption": "Reset time", "id": "stats_reset", "class": "table_obj_value", '
        '"title": "Date and time of the last reset performed in sample"}'
    ']'
    '}]'::jsonb),
...
'[{'
    ...
    '"columns": ['
      '{"caption": "Lock type", "id": "locktype", "class": "table_obj_name", '
        '"title": "Type of the lockable object"},'
      '{"caption": "Waits", "columns": ['
        '{"caption": "Count", "id": "waits", "class": "table_obj_value", '
          '"title": "Number of times a lock of this type had to wait because of a conflicting lock. Only incremented when the lock was successfully acquired after waiting longer than GUC deadlock_timeout"},'
        '{"caption": "%Total", "id": "waits_pct", "class": "table_obj_value", '
          '"title": "Number of wait locks of this type as a percentage of total locks in a cluster"}'
     ']},'
      '{"caption": "Wait time", "columns": ['
        '{"caption": "Time (ms)", "id": "wait_time", "class": "table_obj_value", '
          '"title": "Total time spent waiting for locks of this type. Only incremented when the lock was successfully acquired after waiting longer than GUC deadlock_timeout"},'
        '{"caption": "%Total", "id": "wait_time_pct", "class": "table_obj_value", '
          '"title": "Total time spent waiting for locks of this type as a percentage of total lock time in a cluster"}'
     ']},'
      '{"caption": "Fastpath exceeded", "columns": ['
        '{"caption": "Count", "id": "fastpath_exceeded", "class": "table_obj_value", '
          '"title": "Number of times a lock of this type could not be acquired via fast path because the fast path slot limit was exceeded. Increasing GUC max_locks_per_transaction can reduce this number"},'
        '{"caption": "%Total", "id": "fastpath_exceeded_pct", "class": "table_obj_value", '
          '"title": "Number of fast path locks of this type as a percentage of total locks in a cluster"}'
     ']}'
    ']'
    '}]'::jsonb),
...
(1, 'sqlplan', 'sqlsthdr', 200, 'Top SQL by planning time', 'Top SQL by planning time', 'planning_times', NULL, NULL,
  '[{'
    ...
    '"columns": ['
      ...
      ']}, '
      '{"caption": "Plan types", "condition": "statements_plan_types", "columns": ['
        '{"id": "generic_plan_calls", "class": "table_obj_value", "title": "Number of times the statement has been executed using a generic plan", "caption": "Generic"}, '
        '{"id": "custom_plan_calls", "class": "table_obj_value", "title": "Number of times the statement has been executed using a custom plan", "caption": "Custom"}'
      ']}, '
...
(1, 'ixunused', 'objects', 1000, 'Unused indexes', 'Unused indexes', NULL, NULL,
  ...
  '[{'
    ...
    ']'
  '}]'::jsonb),
(1, 'seqfetch', 'objects', 1100, 'Top sequences by blocks fetched', 'Top sequences by blocks fetched', 'sequence_stat', NULL, NULL,
  '[{'
    '"type": "row_table",'
    ...
    '"columns": ['
     ...
     '{"caption": "Tablespace", "id": "tablespacename", "class": "table_obj_name"},'
     '{"caption": "Schema", "id": "schemaname", "class": "table_obj_name"},'
     '{"caption": "Sequence", "id": "relname", "class": "table_obj_name"},'
     '{"caption": "Fetched", "columns": ['
          '{"id": "blks_fetch", "caption": "Blocks", "title": "Number of blocks fetched (read+hit) from this sequence", "class": "table_obj_value"},'
          '{"id": "blks_fetch_pct", "caption": "%Total", "title": "Blocks fetched from this sequence as a percentage of all blocks fetched in a cluster", "class": "table_obj_value"}'
     ']},'
     '{"caption": "Reads", "columns": ['
          '{"id": "blks_read", "caption": "Blocks", "title": "Number of blocks read from this sequence", "class": "table_obj_value"},'
          '{"id": "blks_read_pct", "caption": "%Total", "title": "Blocks read from this sequence as a percentage of all blocks read in a cluster", "class": "table_obj_value"}'
     ']},'
     '{"caption": "Hits(%)", "id": "hit_pct", "title": "Number of disk blocks hits from this sequence as a percentage of reads + hits", "class": "table_obj_value"}'
    ']'
  '}]'::jsonb),
(1, 'seqread', 'objects', 1200, 'Top sequences by blocks read', 'Top sequences by blocks read', 'sequence_stat', NULL, NULL,
  '[{'
    '"type": "row_table",'
    '"source": "top_sequences",'
    '"filter": {"type": "exists", "field": "ord_read"},'
    ...
    '"columns": ['
     ...
     '{"caption": "Reads", "columns": ['
          '{"id": "blks_read", "caption": "Blocks", "title": "Number of blocks read from this sequence", "class": "table_obj_value"},'
          '{"id": "blks_read_pct", "caption": "%Total", "title": "Blocks read from this sequence as a percentage of all blocks fetched in a cluster", "class": "table_obj_value"}'
     ']},'
     '{"caption": "Hits(%)", "id": "hit_pct", "title": "Number of disk blocks hits from this sequence as a percentage of reads + hits", "class": "table_obj_value"}'
    ']'
  '}]'::jsonb)
...
(2, 'tbspst', 'srvstat', 1400, 'Tablespace statistics', 'Tablespace statistics', NULL, NULL, NULL,
  '[{'
    ...
    ']'
  '}]'::jsonb),
(2, 'lockstat', 'srvstat', 1450, 'Lock statistics', 'Lock statistics', 'stat_lock', NULL, NULL, NULL),
(2, 'lockstatrst', 'srvstat', 1460, NULL, NULL, 'stat_lock_reset', NULL,
  ...
  '[{'
    ...
    '"ordering": "ord_sample",'
    '"columns": ['
      '{"caption": "Sample ID", "id": "sample_id", "class": "table_obj_value", '
        '"title": "Sample identifier with detected reset"},'
      '{"caption": "Lock type", "id": "locktype", "class": "table_obj_value", '
        '"title": "Type of the lockable object"},'
      '{"caption": "Reset time", "id": "stats_reset", "class": "table_obj_value", '
        '"title": "Date and time of the last reset performed in sample"}'
    ']'
...
'[{'
    ...
    '"ordering": "ord_locktype",'
    '"columns": ['
      '{"caption": "Lock type", "id": "locktype", "class": "table_obj_name hdr", "rowspan": true, '
        '"title": "Type of the lockable object"},'
      '{"caption": "I", "id": ["1", "2"], "class": "interval", "title":["properties.timePeriod1", "properties.timePeriod2"]},'
      '{"caption": "Waits", "columns": ['
        '{"caption": "Count", "id": ["waits1", "waits2"], "class": "table_obj_value", '
          '"title": "Number of times a lock of this type had to wait because of a conflicting lock. Only incremented when the lock was successfully acquired after waiting longer than GUC deadlock_timeout"},'
        '{"caption": "%Total", "id": ["waits_pct1", "waits_pct2"], "class": "ttable_obj_value", '
          '"title": "Number of wait locks of this type as a percentage of total locks in a cluster"}'
     ']},'
      '{"caption": "Wait time", "columns": ['
        '{"caption": "Time (ms)", "id": ["wait_time1", "wait_time2"], "class": "table_obj_value", '
          '"title": "Total time spent waiting for locks of this type. Only incremented when the lock was successfully acquired after waiting longer than GUC deadlock_timeout"},'
        '{"caption": "%Total", "id": ["wait_time_pct1", "wait_time_pct2"], "class": "table_obj_value", '
          '"title": "Total time spent waiting for locks of this type as a percentage of total lock time in a cluster"}'
     ']},'
      '{"caption": "Fastpath exceeded", "columns": ['
        '{"caption": "Count", "id": ["fastpath_exceeded1", "fastpath_exceeded2"], "class": "table_obj_value", '
          '"title": "Number of times a lock of this type could not be acquired via fast path because the fast path slot limit was exceeded. Increasing GUC max_locks_per_transaction can reduce this number"},'
        '{"caption": "%Total", "id": ["fastpath_exceeded_pct1", "fastpath_exceeded_pct2"], "class": "table_obj_value", '
          '"title": "Number of fast path locks of this type as a percentage of total locks in a cluster"}'
     ']}'
    ']'
    '}]'::jsonb),
...
(2, 'sqlplan', 'sqlsthdr', 200, 'Top SQL by planning time', 'Top SQL by planning time', 'planning_times', NULL, NULL,
  '[{'
    ...
    '"columns": ['
        ...
        ']}, '
      '{"caption": "Plan types", "condition": "statements_plan_types", "columns": ['
        '{"id": ["generic_plan_calls1", "generic_plan_calls2"], "class": "table_obj_value", "title": "Number of times the statement has been executed using a generic plan", "caption": "Generic"}, '
        '{"id": ["custom_plan_calls1", "custom_plan_calls2"], "class": "table_obj_value", "title": "Number of times the statement has been executed using a custom plan", "caption": "Custom"}'
      ']}, '
...
(2, 'ixgrw', 'objects', 900, 'Top growing indexes', 'Top growing indexes', NULL, NULL,
  ...
  '[{'
    ...
    ']'
  '}]'::jsonb),
(2, 'seqfetch', 'objects', 1100, 'Top sequences by blocks fetched', 'Top sequences by blocks fetched', 'sequence_stat', NULL, NULL,
  '[{'
    '"type": "row_table",'
    '"source": "top_sequences",'
    '"filter": {"type": "exists", "field": "ord_fetch"},'
    ...
    '"columns": ['
     ...
     '{"caption": "Tablespace", "id": "tablespacename", "class": "table_obj_name hdr", "rowspan": true},'
     '{"caption": "Schema", "id": "schemaname", "class": "table_obj_name hdr", "rowspan": true},'
     '{"caption": "Sequence", "id": "relname", "class": "table_obj_name hdr", "rowspan": true},'
     '{"caption": "I", "id": ["1", "2"], "title":["properties.timePeriod1", "properties.timePeriod2"], "class": "interval"},'
     '{"caption": "Fetched", "columns": ['
          '{"id": ["blks_fetch1", "blks_fetch2"], "caption": "Blocks", "title": "Number of blocks fetched (read+hit) from this sequence", "class": "table_obj_value"},'
          '{"id": ["blks_fetch_pct1", "blks_fetch_pct2"], "caption": "%Total", "title": "Blocks fetched from this sequence as a percentage of all blocks fetched in a cluster", "class": "table_obj_value"}'
     ']},'
     '{"caption": "Reads", "columns": ['
          '{"id": ["blks_read1", "blks_read2"], "caption": "Blocks", "title": "Number of blocks read from this sequence", "class": "table_obj_value"},'
          '{"id": ["blks_read_pct1", "blks_read_pct2"], "caption": "%Total", "title": "Blocks read from this sequence as a percentage of all blocks read in a cluster", "class": "table_obj_value"}'
     ']},'
     '{"caption": "Hits(%)", "id": ["hit_pct1", "hit_pct2"], "title": "Number of disk blocks hits from this sequence as a percentage of reads + hits", "class": "table_obj_value"}'
    ']'
  '}]'::jsonb),
(2, 'seqread', 'objects', 1200, 'Top sequences by blocks read', 'Top sequences by blocks read', 'sequence_stat', NULL, NULL,
  '[{'
    '"type": "row_table",'
    '"source": "top_sequences",'
    '"filter": {"type": "exists", "field": "ord_read"},'
    ...
    '"columns": ['
     ...
     '{"caption": "Reads", "columns": ['
          '{"id": ["blks_read1", "blks_read2"], "caption": "Blocks", "title": "Number of blocks read from this sequence", "class": "table_obj_value"},'
          '{"id": ["blks_read_pct1", "blks_read_pct2"], "caption": "%Total", "title": "Blocks read from this sequence as a percentage of all blocks fetched in a cluster", "class": "table_obj_value"}'
     ']},'
     '{"caption": "Hits(%)", "id": ["hit_pct1", "hit_pct2"], "title": "Number of disk blocks hits from this sequence as a percentage of reads + hits", "class": "table_obj_value"}'
    ']'
  '}]'::jsonb)
